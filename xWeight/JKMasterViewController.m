...
- (void)insertNewObject:(id)sender
{
    ...
    [newManagedObject setValue:[NSNumber numberWithFloat:90.0] forKey:@"weight"];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSString *string = [NSString stringWithFormat:@"%@ kg",[[object valueForKey:@"weight"] description]];
    
    cell.textLabel.font = [UIFont fontWithName:@"HelveticaNeue-Bold" size:16.0];
    cell.textLabel.textColor = UIColorFromRGB(0x2d8cee);
